...
tones = ["All"] + ["Happy", "Surprising", "Angry", "Suspenseful", "Sudden"]

with gr.Blocks(theme = gr.themes.Ocean()) as dashboard:
    gr.Markdown("# Semantic book recommender")
    
    with gr.Row():
        user_query = gr.Textbox(label="please enter a description of a book:", placeholder="eg. a book about forgiveness")
